...
data class MyPlantDetailResponse(
    ...
    @field:Schema(name = "내 식물 ID", example = "7")
    val plantId: Int = 0,
    @field:Schema(name = "내 식물 위치 이름", example = "베란다")
    val location: String?,
    @field:Schema(name = "키우기 시작한 날짜", example = "2024-05-17")
    val startDate: LocalDate,
    @field:Schema(name = "마지막으로 물 준 날짜 컴포넌트 제목", example = "마지막으로 물 준 날")
    val lastWateredTitle: String,
    @field:Schema(name = "마지막으로 물 준 날짜 컴포넌트 내용", example = "2024-05-17\n17일전")
    val lastWateredInfo: String,
    @field:Schema(name = "마지막으로 비료 준 날짜 컴포넌트 제목", example = "비료주기")
    val lastFertilizerTitle: String,
    @field:Schema(name = "마지막으로 물 준 날짜 컴포넌트 내용", example = "17일전")
